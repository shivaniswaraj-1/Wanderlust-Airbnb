...
// Default geometry for all listings (for now)
...
module.exports.createListing = async (req,res,next)=>{
    try {
        // Using default geometry for all listings for now
        let geometry = defaultGeometry;

        let url = req.file ? req.file.path : "https://images.unsplash.com/photo-1625505826533-5c80aca7d157";
